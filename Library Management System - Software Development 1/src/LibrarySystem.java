...
public class LibrarySystem {
    ...
    public static void displayFileContents(File userFile){
        Scanner fileContentScanner = null;
        String lineHolder;
        try {
            fileContentScanner = new Scanner(userFile);
        } catch (Exception e) {
            fileContentScanner = null;
            System.out.println("That file does not exist.");
        }
        while(fileContentScanner.hasNextLine()){
            lineHolder = fileContentScanner.nextLine();
